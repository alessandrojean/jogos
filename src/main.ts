    ...
    constructor() {
        ...
        show_about_action.connect('activate', () => {
            const aboutDialog = new Adw.AboutDialog({
                application_name: _('Jogos'),
                application_icon: 'org.jogos.Jogos',
                developer_name: 'Alessandro Jean',
                version: '0.1',
                developers: ['Alessandro Jean <14254807+alessandrojean@users.noreply.github.com>'],
                copyright: '© 2023 Alessandro Jean',
            });
